...
renderValueBox({
  group_pct <- round(100*(sum(group_students()$ENROLL_CNT)/county_students()$ENROLL_CNT), 0)
...
-------------------------------------
```{r}
p("According to NY State Education Department website, a cohort is defined as \"a group of students who first entered grade 9 in the same school year.\" For example, the 2012 cohort is the group of students who entered grade 9 in the year 2012.")
br()
```
