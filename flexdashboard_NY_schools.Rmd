...
# Select county
selectInput(inputId = "county", label = "Choose a county",
            choices = unique(all_stud_long_bar$AGGREGATION_NAME),
            selected = "All Districts and Charters")
...
br()
# Select ethnicity
checkboxGroupInput(inputId = "Ethnicity", label = "Ethnicity", 
...
selected_county <- reactive({
  all_stud_long_bar %>%  
    filter(AGGREGATION_NAME %in% c("All Districts and Charters", input$county)) 
})
