...
# Select metric(s)
checkboxGroupInput(inputId = "metrics", label = "Select Metric(s)", 
...
br()
# Select one or multiple student ethnicities
checkboxGroupInput(inputId = "Ethnicity", label = "Select one or multiple student
                   ethnicities", 
