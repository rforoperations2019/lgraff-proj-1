...
```{r}
p("According to NY State Education Department webiste, a cohort is defined as \"a group of students who first entered grade 9 in the same school year.\" For example, the 2012 cohort is the group of students who entered grade 9 in the year 2012.")
```
...
renderPlot({
  ggplot(cohort_county()) +
    ...
    ylab("") +
    xlab("Year") +
    ggtitle(paste(input$cohortYear, "Cohort in",input$county, "county")) +
    theme(legend.title = element_blank()) +
    scale_y_continuous(breaks=seq(0,1,.10))
})
